...
description: Create engaging, intuitive interactions through motion, feedback, and thoughtful state transitions that enhance usability and delight users. Use when designing hover/focus states, scroll-triggered animations, drag-and-drop, toasts, gestures, loading states, page transitions, or microinteractions.
---
