...
# Cursor：选择设计技能
python3 scripts/install.py --client cursor --skills ops-admin-design --apply
...
本仓库是个人配置集，不宣称所有内容原创。访谈与汇报技能由个人需求和实际反馈整理；其中 5 项能力从个人项目技能中提炼，其余取自个人已安装配置，详见 [来源与整理范围](SOURCES.md)。未对来源未核实的内容统一授予新的开源许可证。
